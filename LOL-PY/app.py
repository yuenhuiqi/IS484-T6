...
from document import upload_multiDocs, dl, getAllDocs, Document, getPresignedUrl, deleteAllDocVersions, update_docDetails
...
def getDoc(file_name):
    return Document.query.filter_by(docName=file_name).first()
